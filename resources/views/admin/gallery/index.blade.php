                  ...
                  <table class="table table-editable table-nowrap align-middle table-edits">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><img class="" width="40" height="50" src="{{ asset('gallery/pic/'.$gall->image) }}" alt="Card image cap" /></td>
                          ...
                          <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    data-bs-target="#small{{ $gall->id }}"><i
                                            class="fa fa-edit-alt me-1"></i> Edit</a>
                                    <a class="dropdown-item" href="javascript:void(0);">
                                      <form action="{{ route('admin.gallery.destroy', $gall->id) }}" method="POST">
                                        @method('delete')
                                        @csrf
                                        <button class="me-2 btn btn-primary waves-effect waves-light" onclick="return confirm('Are you sure?');"><i class=" fa fa-trash me-1"></i>Delete</button>
                                      </form>
                                    </a>
                                </div>
                        </td>
